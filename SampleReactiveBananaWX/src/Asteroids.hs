...
module Asteroids (run) where

import Graphics.UI.WX hiding (Event)
import Graphics.UI.WXCore as WXCore hiding (run)
...
getShareFile :: String -> String
getShareFile = (".stack-work/install/x86_64-osx/lts-9.21/8.0.2/share/x86_64-osx-ghc-8.0.2/reactive-banana-wx-1.1.1.0/" ++)
...
rock    = bitmap $ getShareFile "rock.ico"
burning = bitmap $ getShareFile "burning.ico"
ship    = bitmap $ getShareFile "ship.ico"

explode :: WXCore.Sound ()
explode = sound $ getShareFile "explode.wav"
